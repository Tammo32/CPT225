...
public:
    ...
    // Copy constructor - needed to make the deep copy of NodeLsit
    Node(Node& other);

    // Good to have and makes the comparionsons easy
    // Only check the row and col of the node and does not check 
    // dist_travelled
